...
import com.linghua.hdds.store.Item.FIELDS;
...
//	private HbaseDaoImpl ht;
	...
	public Item get(final String bizCode,final String id, final Collection<Item.FIELDS> fields) {
